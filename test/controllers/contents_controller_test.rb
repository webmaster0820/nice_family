...
class ContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content" do
    assert_difference('Content.count') do
      post contents_url, params: { content: { text: @content.text, title: @content.title, url: @content.url } }
    end
  ...
  test "should update content" do
    patch content_url(@content), params: { content: { text: @content.text, title: @content.title, url: @content.url } }
